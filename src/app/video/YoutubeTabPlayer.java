...
import app.video.Parser;
import app.video.VideoDetail;
import app.video.VideoListAdapter;
...
public class YoutubeTabPlayer extends Activity implements  OnItemClickListener{
	...
	private static final String url="http://gdata.youtube.com/feeds/api/playlists/" +
				"PLsvoYlzBrLFAJd4hNQSHw1lYjDKeQB_iU"+//Your playlist ID
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter=new VideoListAdapter(YoutubeTabPlayer.this, list);		
	...
	class LoadMoviesAsync extends AsyncTask<String,VideoDetail,Void>{
		...
		protected void onPreExecute() {
			dialog=new ProgressDialog(YoutubeTabPlayer.this);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {				
		Intent i=new Intent(YoutubeTabPlayer.this,YouTubeMain.class);
